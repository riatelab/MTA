...
output:
  ...
  pdf_document:
    toc: yes
vignette: |
  %\VignetteIndexEntry{MTA Explained} %\VignetteEngine{knitr::rmarkdown} \usepackage[utf8]{inputenc}
---
...
library(png)
library(grid)
img <- readPNG("C:/Users/Ronan/Desktop/MTA/data/figure_MTA1.png")
grid.raster(img)
```
...
```{r fig.width=10,echo=FALSE}
img <- readPNG("C:/Users/Ronan/Desktop/MTA/data/figure_MTA2.png")
grid.raster(img)
```
...
```{r fig.width=10,echo=FALSE}
img <- readPNG("C:/Users/Ronan/Desktop/MTA/data/figure_MTA3.png")
grid.raster(img)
```
