...
The MTA methodology proposed by HyperAtlas has also been developed for decision making and monitoring in a policy context at EU (ESPON Program, [European Parliament](https://www.europarl.europa.eu/thinktank/en/document.html?reference=IPOL-REGI_ET(2007)379205 "Web page for this European Parliament study and HyperAtlas") ) and national levels (Romania, Tunisia, Belgium, Cameroon, Nordic countries, France etc.).
...
To understand how to use `MTA` functions and results, you are invited to consult the [R Package vignette](https://cran.r-project.org/web/packages/MTA/vignettes/MTA_Scenario.html), on income inequalities ; or the [Rzine publication]((https://rysebaert.github.io/mta_rzine/) on employment inequalities. 
